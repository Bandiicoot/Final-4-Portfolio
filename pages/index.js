...
function main() {
  container = document.querySelector(".header-index");
  header(container);

  containerForm = document.querySelector(".container-index");
  fomrulario(containerForm);

  containerFooter = document.querySelector(".container-footer");
